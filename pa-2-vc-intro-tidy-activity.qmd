...
**NAMES:** Gurpreet Kaur and Isabella Chan 
...
#added 14 to every number in top_secret
...
```{r}
#| label: even-numbers
# creating a vector of all even numbers
...
```{r}
#| label: matrix-into-vector
#turned the matrix back into a vector
...
```{r}
#| label: vector-mysymbols
# final message using vector
code_vector_update |> 
